...
if _world_job_enable.exists():
    ...
    _world_allowed={'validate_measured_landscape.py','import_park_pavement.py','build_park_splines.py','validate_park_world.py','build_park_lake.py','validate_v2_bike.py','validate_park_ride.py','validate_explorer.py','validate_swimming.py'}
