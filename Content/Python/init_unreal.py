...
if _world_job_enable.exists():
    ...
    _world_allowed={'validate_measured_landscape.py','import_park_pavement.py','build_park_splines.py','validate_park_world.py','build_park_lake.py','validate_v2_bike.py','validate_park_ride.py','validate_explorer.py','validate_swimming.py','validate_combat_rules.py','prepare_combat_assets.py','validate_threats.py','validate_lights.py','install_lake_bridge.py','validate_lake_bridge.py','validate_underpass.py','build_park_navigation.py','validate_threat_navigation.py','validate_park_traffic.py','build_arcade_lab.py','validate_arcade_bike.py','validate_battle_fps.py','prepare_battle_effects.py','validate_battle_action.py','validate_battle_ride_details.py','import_fps_arms.py','validate_fps_arms.py','prepare_ride_effects.py','validate_ride_feedback.py','install_battle_park.py','validate_battle_park.py'}
    def _world_job_tick(delta):
        ...
        try:
            ...
            if target_map:
                if target_map not in {'/Game/PiedmontRide/Maps/PiedmontWorld','/Game/PiedmontRide/Maps/BikePhysicsLab','/Game/BattleForTheA/Maps/ArcadeBikeLab'}:raise RuntimeError('Unknown development map')
