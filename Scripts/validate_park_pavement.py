...
P=Path(__file__).resolve().parents[1];O=P/'SourceAssets/Terrain';B=O/'ParkPavement'
...
(P/'Tests/Results/2026-09-10-park-pavement-source.json').write_text(json.dumps(report,indent=2));print(json.dumps({k:v for k,v in report.items() if k!='results'},indent=2))
