...
settings={'shadow_bias':.15,'shadow_slope_bias':.3,'contact_shadow_length':.03,'shadow_resolution_scale':2.0}
...
(root/'Tests/Results/2026-09-13-turnaround-shadow-candidate.json').write_text(json.dumps({'settings':rows,'main_map_changed':False,'visual_accepted':False,'scope':'Lower bias and screen-space contact shadows on review-map sunlight only; appearance and performance pending.'},indent=2)+'\n')
