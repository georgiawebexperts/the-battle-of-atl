...
try:
    ...
    land=unreal.PiedmontWorldTools.import_measured_landscape(str(p/'SourceAssets/Terrain/atlanta-height.r16'),meta['size'][0],meta['size'][1],unreal.Vector(*meta['unreal_location_cm']),unreal.Vector(*meta['unreal_scale']))
