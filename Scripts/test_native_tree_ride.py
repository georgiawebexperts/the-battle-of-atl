...
root=pathlib.Path(__file__).resolve().parents[1];log=root/'work/tree-ride-audit.log'
...
(root/'Tests/Results/2026-09-12-native-tree-ride.json').write_text(json.dumps(r,indent=2)+'\n');print(json.dumps(r));raise SystemExit(0 if r['passed'] else 1)
