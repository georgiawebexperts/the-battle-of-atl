...
for variant in ['male','female']:
 ...
 out=root/('work/build044-city-knockdown-review' if args.hard else 'work/build044-city-bump-review' if args.bump else 'work/build044-city-review')/variant;
...
result_path=root/('Tests/Results/2026-09-11-build044-city-knockdowns.json' if args.hard else 'Tests/Results/2026-09-11-build044-city-bumps.json' if args.bump else 'Tests/Results/2026-09-11-build044-city-walkers.json')
