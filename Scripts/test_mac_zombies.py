"""Exercise zombie spawning, navigation and actual pistol combat in the cooked Mac game."""
import json,re,subprocess,argparse
from pathlib import Path
root=Path(__file__).resolve().parents[1]
parser=argparse.ArgumentParser();parser.add_argument('--report',default='2026-09-11-native-zombie-combat.json');args=parser.parse_args()
