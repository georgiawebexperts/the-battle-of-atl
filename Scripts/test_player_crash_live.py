...
r['passed']=(not args.detailed_rider or r['detailed_assets_loaded']) and r['requested_flow_covered'] and r['capture_passed'] and r['pose_fit_nonregression'] and result.returncode==0 and bool(r['audit']) and r['audit']['passed']
