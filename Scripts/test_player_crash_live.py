...
p=argparse.ArgumentParser();p.add_argument('--app',type=pathlib.Path);p.add_argument('--report');mode=p.add_mutually_exclusive_group();mode.add_argument('--taser',action='store_true');mode.add_argument('--drone',action='store_true');mode.add_argument('--death',action='store_true');mode.add_argument('--repeat',action='store_true');mode.add_argument('--death-on-foot',action='store_true');args=p.parse_args()
