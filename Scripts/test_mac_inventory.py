...
if a.body_hands:flags+=['-BattleShotgunHandAudit']
...
hands=re.findall(r'BattleShotgunHands: (\{[^\n]+\})',log.read_text())
result['body_hand_audit']=json.loads(hands[-1]) if hands else None
