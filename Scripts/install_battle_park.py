...
points=json.loads((root/'SourceAssets/Terrain/battle-start.json').read_text());pos=unreal.Vector(*points['world_start_xy_cm'],0);hit=unreal.PiedmontWorldTools.trace_world_surface(pos+unreal.Vector(0,0,2000),pos-unreal.Vector(0,0,2000),2)
...
start.set_actor_label('14th Street gate — V3 park start');start.set_actor_location_and_rotation(hit[0]+unreal.Vector(0,0,102),unreal.Rotator(yaw=points['world_heading_yaw']),False,True)
