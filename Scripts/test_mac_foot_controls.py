...
if a.interruptions:
 assert a.editor and a.detailed_rider
 flags+=['-BattleReloadInterruptAudit']
...
if a.interruptions:
 d['reload_interruptions_passed']='DetailedReloadInterruptions: holster/switch/remount passed' in (out/'run.log').read_text()
 d['passed']=bool(d['passed'] and d['reload_interruptions_passed'])
