...
parser=argparse.ArgumentParser();parser.add_argument('--packaged',action='store_true');parser.add_argument('--report',default='2026-09-13-third-person-aim-pitch.json');args=parser.parse_args();assert Path(args.report).name==args.report
