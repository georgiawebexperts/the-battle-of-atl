...
parser=argparse.ArgumentParser();parser.add_argument('--packaged',action='store_true');parser.add_argument('--serial-pso',action='store_true');parser.add_argument('--close',action='store_true');parser.add_argument('--right-side',action='store_true');parser.add_argument('--weapon',choices=['pistol','shotgun','smg','rifle'],default='pistol');parser.add_argument('--report',default='2026-09-13-third-person-aim-pitch.json');args=parser.parse_args();assert Path(args.report).name==args.report
