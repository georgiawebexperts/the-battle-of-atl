...
report={'locomotion_review':args.locomotion,'captures_passed':True,'exit_code':run.returncode,'images':images,'visual_review':'pending','scope':('Native cooked Mac game, controlled walking/running/idle fixture; audio disabled; no physical input or FPS acceptance.' if args.locomotion else 'Native cooked Mac game, controlled bike-to-foot fixture; audio disabled; no physical input or FPS acceptance.')}
