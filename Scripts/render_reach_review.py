"""Transient editor pose diagnostic for the reaching candidate; not gameplay acceptance."""
import unreal,json,pathlib
root=pathlib.Path(unreal.Paths.project_dir());out=root/'work/reach-review';out.mkdir(parents=True,exist_ok=True)
...
results=[]
variants=[('Male','m_tal_nrw','crewneck','m_001','Hair_S_AfroFade','/Game/BattleRetarget/Mixamo/ReachCandidate/MixamoReachReference_Anim')]
