...
with log.open('w') as stream:
 run=subprocess.run(entry+[f'/Game/PiedmontRide/Maps/PiedmontWorld?Difficulty={a.difficulty}?AutoStart=1','-game','-RCWebControlDisable','-nullrhi','-unattended','-nosound','-BattleSkipTutorial','-BattleTroubleAudit','-stdout'],stdout=stream,stderr=subprocess.STDOUT,timeout=120)
