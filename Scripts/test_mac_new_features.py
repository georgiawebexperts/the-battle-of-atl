...
p=argparse.ArgumentParser();p.add_argument('kind',choices=['music','bikes','balance']);p.add_argument('--review',action='store_true');p.add_argument('--aerial',action='store_true');p.add_argument('--packaged',action='store_true');p.add_argument('--report',required=True);a=p.parse_args()
