...
parser=argparse.ArgumentParser();parser.add_argument('--render',action='store_true');parser.add_argument('--motion',action='store_true');parser.add_argument('--grip',action='store_true');parser.add_argument('--opposite',action='store_true');parser.add_argument('--detailed-gunman',action='store_true');parser.add_argument('--app');parser.add_argument('--report');args=parser.parse_args()
