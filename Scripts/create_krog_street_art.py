...
u=binary(unreal.MaterialExpressionDotProduct,world,node(unreal.MaterialExpressionConstant3Vector,constant=unreal.LinearColor(.000333,.001056,0)))
...
wire(sample,blend,'A','RGB');wire(node(unreal.MaterialExpressionConstant3Vector,constant=unreal.LinearColor(.19,.18,.16)),blend,'B');wire(absolute,blend,'Alpha')
