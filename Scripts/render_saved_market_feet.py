...
root=pathlib.Path(unreal.Paths.project_dir());out=root/'work/market-feet-saved-review';out.mkdir(exist_ok=True)
assert unreal.EditorLoadingAndSavingUtils.load_map('/Game/PiedmontRide/Maps/PiedmontMarketFeetReview')
...
unreal.RenderingLibrary.export_render_target(world,tex,str(out),"saved.png")
