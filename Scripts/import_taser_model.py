...
root=pathlib.Path(unreal.Paths.project_dir());dest='/Game/BattleForTheA/Police/Taser'
t=unreal.AssetImportTask();t.filename=str(root/'SourceAssets/Weapons/Taser/Taser.gltf');t.destination_path=dest;t.automated=True;t.save=True;t.replace_existing=True
...
(root/'work/taser-import.json').write_text(json.dumps(rows,indent=2)+'\n');unreal.SystemLibrary.quit_editor()
