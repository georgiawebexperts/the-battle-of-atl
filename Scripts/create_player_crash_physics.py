...
(root/'Tests/Results/2026-09-12-player-crash-physics-candidate-v2.json').write_text(json.dumps({'asset':asset.get_path_name(),'live_mesh_assignment_changed':False,'main_map_changed':False,'scope':'Auto-fitted capsules and joint constraints generated. Physical stability, body clearance, mounted pose transfer, recovery and gameplay integration unverified.'},indent=2)+'\n')
