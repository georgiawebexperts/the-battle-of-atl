...
(root/'Tests/Results/2026-09-12-player-crash-physics-candidate-v6.json').write_text(json.dumps({'asset':asset.get_path_name(),'live_mesh_assignment_changed':False,'main_map_changed':False,'scope':'Convex hulls fitted to imported dominant-weight vertices including descendants without physics bodies; 1.5cm radial expansion; auto-generated constraints retained. Physical stability, body clearance, mounted pose transfer, recovery and gameplay integration unverified.'},indent=2)+'\n')
