...
parser=argparse.ArgumentParser();parser.add_argument('--recovery',action='store_true');parser.add_argument('--bike',action='store_true');parser.add_argument('--double-road',action='store_true');parser.add_argument('--solid-support',action='store_true');parser.add_argument('--free-joints',action='store_true');parser.add_argument('--pose-mirror',action='store_true');args=parser.parse_args()
