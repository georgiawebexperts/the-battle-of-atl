...
log=root/f'work/build034-jump-{a.difficulty.lower()}.log'
...
(root/f'Tests/Results/2026-09-11-build034-jump-{a.difficulty.lower()}.json').write_text(json.dumps(result,indent=2)+'\n');print(json.dumps(result))
