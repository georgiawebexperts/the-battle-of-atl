...
p.add_argument('--saddle-close',action='store_true')
...
result['landing_saddle']=re.findall(r'LandingSaddleAudit: minimum_hip_z_cm=([0-9.]+) clear=(\d+)',log.read_text())
