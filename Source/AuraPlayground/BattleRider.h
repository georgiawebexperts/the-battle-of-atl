...
public:
 ...
 float ShotgunPumpTravel=0,ShotgunReloadBlend=0;
 FVector ShotgunReloadHand=FVector(4,-3,-4);
 bool bShotgunReloading=false;
 void UpdateShotgunMechanism(float Dt);
 void UpdateShotgunVisual();
 void StartShotgunReload();
 void FinishShotgunReload();
 void TransferShotgunShells(int32 Count);
 float ShotgunPumpRemaining=0;
 float ShotgunReloadDuration=0,ShotgunReloadLead=0,ShotgunShellPhase=0;
 int32 ShotgunReloadShells=0,ShotgunInsertedShells=0;
