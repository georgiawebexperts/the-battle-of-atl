...
public class AuraPlayground : ModuleRules {
 public AuraPlayground(ReadOnlyTargetRules Target):base(Target) {
  if(Target.bBuildEditor)PrivateDependencyModuleNames.AddRange(new string[]{"UnrealEd","LandscapeEditor","Water","MeshDescription"});
  PrivateDependencyModuleNames.AddRange(new string[]{"ApplicationCore","PCG","Json"});
