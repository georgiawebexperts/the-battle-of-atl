...
void ABattleEnemyDirector::BeginPlay(){
 ...
 for(const TCHAR* Flag:{TEXT("BattleAudit"),TEXT("BattleHealthAudit"),TEXT("BattleGeographyAudit"),TEXT("BattleConnectorAudit"),TEXT("BattleEastsideAudit"),TEXT("BattleKrogAudit")})if(FParse::Param(FCommandLine::Get(),Flag))bFreezeSpawns=true;
 #endif
}
