...
ABattleDanceCircle::ABattleDanceCircle(){
 ...
 Label=CreateDefaultSubobject<UTextRenderComponent>(TEXT("DanceLabel"));Label->SetupAttachment(RootComponent);Label->SetRelativeLocation(FVector(0,0,125));Label->SetText(FText::FromString(TEXT("PARK DJ")));Label->SetWorldSize(16);Label->SetHorizontalAlignment(EHTA_Center);Label->SetTextRenderColor(FColor(255,185,100));
