...
void ABattleLabMode::Tick(float Dt){
 ...
 // The gear keys belong here: the HUD shows GEAR 5/5 from the first second, and
...
void ABattleBike::PoseRider(float Dt){
 ...
 auto Index=[&](const TCHAR* Name){return BoneNames.IndexOfByKey(BattleDetailedBone(FName(Name),bDetailedRiderPreview));};
