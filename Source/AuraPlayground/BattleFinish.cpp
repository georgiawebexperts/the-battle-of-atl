...
bool ABattleParkMode::CompleteRun(ABattleBike* Bike){
 ...
 const bool TimeSaved=BattleRecords::Record(DifficultyName,RunElapsed);const bool WinSaved=BattleRecords::AddWin(DifficultyName);bRecordSaved=TimeSaved&&WinSaved;Bike->Ride->Speed=Bike->Ride->Pedal=Bike->Ride->Steer=0;Bike->Ride->StopMovementImmediately();
