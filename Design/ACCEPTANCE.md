...
| Rare combat with continuous clock | Prototype rare encounters, first-stab dismount/chase, second-stab death before remount, fatal bullets, on-foot-only gun defense, blood particles and item reset have live/unit integration evidence. Runtime waypoint pursuit and reachable rare spawns pass a 106-game-meter lake detour/first-stab escape test plus combat regressions. Full-world moving-target/crowd navigation, production shooting/hit/death effects and convincing animation remain unaccepted. |
