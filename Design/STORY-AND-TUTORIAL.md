...
## Reachable 12th Street market approach — 2026-09-12 [codex-maclaptop]

Found previous south practice fence650cm below13th/Piedmont prevented reaching the new12th Street market. Generator now follows mapped Piedmont Avenue way9272986 from13th to an authored expansion stop700cm south of the12th Street gate; moves only that south barrier and extends its road stub. Uses retained References/twelfth-market.osm and existing terrain-height function. MarketApproach audit endpoint stops four100cm samples short of the fence. Does not yet add the market gate closure or install market stalls.

Native editor build passes. Actual keyboard route tests pass: market approach4470.2cm (max centreline error4.3cm), original direct gate route7694.4cm (12.7cm), alternate Juniper route25021.7cm (16.4cm). Market ride stays untimed without wipeout; both gate routes preserve dismount/remount and one-time countdown/start. Tests sweep existing/moved fences for blocking. Visual street joins, manual turns, grass bypasses and future market gate closure remain unaccepted. No packaged update; desktop050 unchanged. Reproduce with Scripts/test_tutorial_routes.py market|direct|alternate.
